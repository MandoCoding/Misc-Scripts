// ==UserScript==
// @name Magic
// @author ThotDev, DumbCodeGenerator
...
// @match https://leakedmodels.com/forum/threads/*
// @match https://forum.lewdweb.net/*
// @match https://leakemup.com/*
// @match https://nudostar.com/forum/*
// @match https://thefappeningblog.com/forum/threads/*
// @require https://code.jquery.com/jquery-3.3.1.min.js
// @require https://cdnjs.cloudflare.com/ajax/libs/jszip/3.1.5/jszip.min.js
// @require https://unpkg.com/file-saver@2.0.4/dist/FileSaver.min.js
// @require https://cdn.jsdelivr.net/npm/m3u8-parser@4.5.2/dist/m3u8-parser.min.js
// @connect self
// @connect thefappeningblog.com
...
// @connect theslutbay.com
// @connect smgmedia.socialmediagirls.com
// @connect symedia.sexy-youtubers.com
...
jQuery(function ($) {
    $('.message-attribution-opposite')
        ...
        .each(function () {
            var downloadLink = $('<li><a href="#" class="downloadSinglePost"><img src="https://s1.putme.ga/Download27127ce76bc766ac.gif" alt="Download" border="0" width="15" height="15"> Download</a><li>');
    ...
    var downloadAllLink = $('<a href="#" class="downloadAllFiles"><img src="https://s1.putme.ga/Download27127ce76bc766ac.gif" alt="Download" border="0" width="15" height="15"> Download All</a>');
